...
include::../spring-akka-gradle/README.adoc[tags=content]
include::../gradle-starter/README.adoc[tags=content]
include::../rxkotlin-example/README.adoc[tags=content]
include::../reactivex-api/README.adoc[tags=content]
include::../javaee-starter/README.adoc[tags=content]
include::../starter/README.adoc[tags=content]
include::../stock/README.adoc[tags=content]
